...
namespace Soat.HappyNet.Silverlight.Library.Behaviors.Actions
{
	...
	/// </summary>
    public class SetProperty : BindableTargetedTriggerAction<FrameworkElement>
    {
        ...
        {
            get { return (Binding)GetBinding(SetProperty.ValueProperty); }
            set { SetBinding<object>(SetProperty.ValueProperty, value); }
        }
