// -----------------------------------------------------------------------
// <copyright file="HandlerExtensions.cs" company="So@t">
...
namespace Soat.HappyNet.Silverlight.Library.Components
{
    public static class HandlerExtensions
    {
        ...
        {
            if (handler == null) throw new ArgumentException("handler");
            if (count < 1) throw new ArgumentOutOfRangeException("count", "Handle Exactly count cannot be less than 1");
        ...
        public static HandlerBase<PropertyChangedEventArgs, PropertyChangedEventHandler> HandleFor
            (this HandlerBase<PropertyChangedEventArgs, PropertyChangedEventHandler> handler, 
            Expression<Func<Object>> propertySelector)
        {
            if (handler == null) throw new ArgumentException("handler");
            if (propertySelector == null) throw new ArgumentException("period cannot be negative.");
        ...
        public static T HandleFor<T>(this T handler, Expression<Func<Object>> propertySelector)
            where T : HandlerBase<PropertyChangedEventArgs, PropertyChangedEventHandler>
        {
        ...
        {
            if (handler == null) throw new ArgumentException("handler");
            if (period.Ticks < 0) throw new ArgumentException("period");
        ...
        {
            if (handler == null) throw new ArgumentException("handler");
            if (period <= TimeSpan.Zero) throw new ArgumentException("period", "period cannot be negative.");
