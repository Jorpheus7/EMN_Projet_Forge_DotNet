// -----------------------------------------------------------------------
// <copyright file="MainModuleTest.cs" company="So@t">
...
namespace Soat.HappyNet.Silverlight.Tests.Main
{
    [TestClass]
    public class MainModuleTest : SilverlightTest
    {
        ...
        public MainModuleTest()
        {
            ...
            this.Container.RegisterType<IMainService, MainService>();
        }
